...
<body>
    ...
    <div class="card" style="margin-bottom: 25px;">
        <h1>🩸 SmO2 Sci-Analyzer v19.2</h1>
        <p class="subtitle">Top-3 Parsimony • Dual Dmax • LTP • PDF (One Plot/Page)</p>

        <div class="controls-grid">
            <div class="file-box" style="grid-row: span 2;">
                <label for="file_upload" style="cursor:pointer; margin:0;">📂 Upload Excel/CSV</label>
        ...
        <button id="btn_pdf" class="btn-pdf" onclick="downloadPDF()">📥 DOWNLOAD PDF REPORT</button>
        
        <div id="loader" class="loading">
            ⏳ <b>Processing...</b> Reading File • Filtering Outliers • Calculating Models
        </div>
    ...
    <div id="results_area" style="display:none;">
        ...
        <div class="charts-main">
            <div class="card">
                <h3>📈 Best Fit (Parsimony Corrected)</h3>
                <div id="plot_main"></div>
            </div>
            <div class="card">
                <h3>⟳ Rate of Change (Smoothed)</h3>
    ...
    <script type="py">
        ...
        async def run_analysis(event):
            try:
                ...
                if r1['warnings']:
                    document.getElementById("warn_msg").innerHTML = "<b>⚠️ Quality Alert:</b><br>" + "<br>".join(r1['warnings'])
